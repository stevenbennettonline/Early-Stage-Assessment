...
\noindent\LARGE{\textbf{Synthetic Accesibility of Organic Materials}} \\%Article title goes here instead of the text "This is the title"
\noindent\large{Steven Bennett,{$^*$} Kim Jelfs} \\%Author names go here instead of "Full name", etc.
\newline
\noindent\large{CID: 00957234}
...
Synthetic accessibility (SA) is an important filter for generating suitable candidates for high-throughput materials screening. As the generative capabilities of computational techniques increase, the number of proposed novel compounds with favourable properties is exponentially increasing.   

\section{Methods}

\paragraph{Measuring Synthetic Accessibility}
...
\section{Future Plans and Outlook}

\paragraph{Accelerating Genetic Algorithms with Deep Learning}
